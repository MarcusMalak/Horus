...
from import_existing import check_data
...
weather_test = [(carla.WeatherParameters.ClearNoon, 4),
           (carla.WeatherParameters.ClearSunset, 4),
           (carla.WeatherParameters.CloudyNoon, 4),
           (carla.WeatherParameters.HardRainNoon, 3)]
...
# map_split_train = int(no_scenes_train*0.5)
# map_split_test = int(no_scenes_test*0.5)
    ...
    for scene, info in scenes.items():
        ...
        try:
            ...
            if scene_start:
                ...
                existing = check_data(output_dir, "horus-", tt)
