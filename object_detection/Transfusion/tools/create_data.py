...
def nuscenes_data_prep(root_path,
    ...
    #     root_path, info_prefix, bug_fix, version, max_sweeps)
    #
    ...
    # nuscenes_converter.create_nuscenes_infos(
    #     root_path, info_prefix, True, version=version, max_sweeps=max_sweeps)
    #
    # if version == 'v1.0-test':
    #     return
    #
...
if __name__ == '__main__':
    print(args)
    # args = argparse.Namespace(dataset='nuscenes', extra_tag='mini_set_3', max_sweeps=5,
    #                           out_dir='../data/mini_set_10',
    #                           root_path='/home/marcus/MasterThesis/TransFusion/data/mini_set_10',
    #                           version='mini_set_10', workers=4)
