...
def main():
    args = parse_args()
    # args = argparse.Namespace(autoscale_lr=False, cfg_options=None, config='/home/marcus/MasterThesis/TransFusion/configs/transfusion_nusc_pillar_L.py',
    #                           deterministic=False, gpu_ids=None, gpus=None, launcher='none', local_rank=0,
    #                           no_validate=False, options=None, resume_from=None, seed=0, work_dir=None)
