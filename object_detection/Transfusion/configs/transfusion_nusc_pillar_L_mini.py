...
# data_root = '../../mmdetection3d/data/mini_set_3'
data_root = '/home/marcus/MasterThesis/TransFusion/data/mini_set_3'
input_modality = dict(
    use_lidar=True,
    use_camera=False,
    use_radar=False,
...
train_pipeline = [
    ...
    dict(
        ...
        db_sampler=dict(
            data_root=None,
            info_path=data_root + '/mini_set_3_dbinfos_train.pkl',
            rate=1.0,
            prepare=dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + '/mini_set_3_infos_train.pkl',
            load_interval=1,
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + '/mini_set_3_infos_val.pkl',
        load_interval=1,
